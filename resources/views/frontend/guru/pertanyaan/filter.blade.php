                        ...
                        <div class="col-12">
                            <div class="card mt-2">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <form action="{{ route('pertanyaan.filter') }}" method="get" class="site-block-top-search" >
                                                @csrf
                                                <div class="row mb-3">
                                                    <div class="col-6">
                                                      <select class="form-control" name="cari" id="cari">
                                                        <option>---pilih category Soal---</option>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{ route('pertanyaan.destroy', $p->id) }}" method="DELETE">
                                                                        @csrf
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('pertanyaan.store') }}" method="post">
            @csrf
            <div>
                <label for="category_soal">Category Soal</label>
                <select name="category_soal_id" id="category_soal_id" class="form-control">
                   @foreach($category_soal as $p)
                        <option value="{{ $p->id }}">{{ $p->name }}</option>
                   @endforeach
                </select>
            ...
            <div class="mt-3">
                ...
                <textarea class="form-control" placeholder="masukan pertanyaan/soal" name="question_text"></textarea>
            </div>
